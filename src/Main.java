...
import view.PropertyListController;
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        propertyListLoader.setController(new PropertyListController(propertyListVM));
        ...
        bookingLoader.setController(new BookingController(bookingVM));
